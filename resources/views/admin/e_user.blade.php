                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-vertical" class="form-control" name="name"
                                        value="{{$user->name}}" placeholder="Masukan Tanggal">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-vertical" class="form-control" name="nip"
                                        value="{{$user->nip}}" placeholder="Masukan NIP">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-vertical" class="form-control" name="kode"
                                        value="{{$user->kode}}" placeholder="Masukan Kode">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-vertical" class="form-control" name="username"
                                        value="{{$user->username}}" placeholder="Masukan Tanggal">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" id="first-name-vertical" class="form-control" name="email"
                                        value="{{$user->email}}" placeholder="Masukan Tanggal">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="contact-info-vertical">Jabatan</label>
                                    <select class="form-select form-select form-control" name="jabatan"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-select form-select form-control" name="role"
                                        aria-label="Small select example">
