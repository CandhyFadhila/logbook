                        ...
                        <table class="table" id="table2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ ++$i }}</td>
                                    <td>{{$a->name}}</td>
                                    <td><img class="avatar me-3" src="{{ asset('public/Image/' . $a->image) }}"
                                            style="width: 250px; height:250px;" alt=""></td>
                                    <td>{{$a->username}}</td>
                                    <td>{{$a->email}}</td>
                                    <td>{{$a->jabatan}}</td>
                                    <td>{{$a->role}}</td>
                                    <td>
                                        <a href="/user/edit/{{$a->id}}" type="Detail"
                                        ...
                                        <form id="delete-form-{{ $a->id }}" action="/user/delete/{{ $a->id }}"
